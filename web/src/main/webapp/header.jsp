...
<%@ page import="vn.edu.hcmuaf.fit.Web_ban_hang.dao.model.User" %>
                ...
                <div class="header-account">
                    ...
                    <div class="account-info">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="login"><span class="account-text">Đăng Nhập / Đăng Ký</span></a>
                                <a href="login"><span class="account-menu"> Tài Khoản Của Tôi <i
