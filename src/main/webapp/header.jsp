                                    ...
                                    <div class="account-info">
                                        <c:choose>
                                            <c:when test="${not empty user.getUsername()}">
                                                ...
                                                <a href="${pageContext.request.contextPath}/change-password"><span
                                                        class="account-menu"> Đổi mật khẩu </span></a>
                                                <a href="${pageContext.request.contextPath}/logout"><span
                                                        class="account-menu"> Đăng Xuất <i
                            ...
                            <ul class="menu">
                                ...
                                <c:if test="${not empty sessionScope.category}">
                                    <c:forEach var="category" items="${sessionScope.category}">
                                        <li>
                                            <a
                                                href="${pageContext.request.contextPath}/list-product?category=${category.id}">${category.name}</a>
                                        </li>
                                    </c:forEach>
                                </c:if>
                            </ul>
